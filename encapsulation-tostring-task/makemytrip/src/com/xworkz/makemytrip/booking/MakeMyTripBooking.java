...
public class MakeMyTripBooking {
    ...
    public void getBookingDetails(){
        System.out.println("Passenger Name: " + this.dto.getPassengerName());
        System.out.println("Email: " + this.dto.getEmail());
        System.out.println("Contact Number: " + this.dto.getContactNumber());
        System.out.println("From: " + this.dto.getDepartureCity());
        System.out.println("To: " + this.dto.getArrivalCity());
        System.out.println("Travel Date: " + this.dto.getTravelDate());
        System.out.println("Number of Passengers: " + this.dto.getNumberOfPassengers());
        System.out.println("Fare: " + this.dto.getFare());
