...
public class Student {
    ...
    public void getStudentDetails(){
        System.out.println("----------------------------------");
        System.out.println("Student Name: " + this.studentDto.getStudentName());
        System.out.println("Roll Number: " + this.studentDto.getRollNumber());
        System.out.println("DOB: " + this.studentDto.getDob());
        System.out.println("Gender: " + this.studentDto.getGender());
        System.out.println("Email: " + this.studentDto.getEmail());
        System.out.println("Mobile: " + this.studentDto.getMobile());
        System.out.println("Department: " + this.studentDto.getDepartment());
        System.out.println("Percentage: " + this.studentDto.getPercentage());
