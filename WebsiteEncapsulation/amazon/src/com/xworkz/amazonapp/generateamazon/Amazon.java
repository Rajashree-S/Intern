...
public class Amazon {
    ...
    AmazonCustomerDto dto;
    public boolean placeOrder(AmazonCustomerDto dto) {
    ...
    public boolean validateOrder(AmazonCustomerDto dto) {
    ...
    public void getAmazonCustomerDetails(){
        System.out.println("----------------------------------");
