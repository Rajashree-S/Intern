...
public class MovieBooking {
    ...
    public void getMovieBookingDetails(){
        ...
        System.out.println("Movie: " + this.dto.getMovieName());
        System.out.println("Theatre: " + this.dto.getTheatreName());
        System.out.println("Show Time: " + this.dto.getShowTime());
        System.out.println("Tickets: " + this.dto.getNumberOfTickets());
        System.out.println("Seat Type: " + this.dto.getSeatType());
