...
public class CourseRegistration {
    ...
    public void getCourseDetails(){
        ...
        System.out.println("Name: " + this.dto.getStudentName());
        System.out.println("ID: " + this.dto.getStudentId());
        System.out.println("Course: " + this.dto.getCourseName());
        System.out.println("Code: " + this.dto.getCourseCode());
        System.out.println("Department: " + this.dto.getDepartment());
        System.out.println("Semester: " + this.dto.getSemester());
